...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="mb-4 text-xl font-semibold text-gray-800">Create Skill</h2>}
        >
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-6">
                            <form onSubmit={submit} noValidate>
                                ...
                                <div className="form-group mb-3">
                                    <label htmlFor="sort_order">Percentage</label>
                                    <input
                                        type="number"
                                ...
                                <Link href={route('skills.index')} className="btn btn-secondary ms-2">
                                    Cancel
                                </Link>
                            </form>
                        </div>
