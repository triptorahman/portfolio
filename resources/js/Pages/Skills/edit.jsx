...
export default function Edit({ skill }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Skill Section</h2>}
        >
            <Head title="Edit Skill Section" />
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden rounded bg-white p-6 shadow-sm">
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* Percentage */}
                            <div className="mb-4">
                                <label htmlFor="sort_order" className="block text-sm font-medium text-gray-700">Percentage</label>
                                <input
                                    type="number"
                                    name="percentage"
                                    id="percentage"
                                    ...
                                    min="1"
                                />
                                {errors.percentage && <div className="mt-1 text-sm text-red-600">{errors.percentage}</div>}
                            </div>
