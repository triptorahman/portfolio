            ...
            <nav className="border-b border-gray-100 bg-white">
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    href={route("section-overview-content.index")}
                                    active={route().current(
                                        "section-overview-content.index"
                                    )}
                                >
                ...
                >
                    <div className="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            href={route("hero-sections.index")}
                            active={route().current("hero-sections.index")}
                        >
                            Hero Sections
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                        ...
                        <ResponsiveNavLink
                            href={route("section-overview-content.index")}
                            active={route().current("section-overview-content.index")}
                        >
                            Section Overview Content
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                        ...
                        <ResponsiveNavLink
                            href={route("portfolio-types.index")}
                            active={route().current("portfolio-types.index")}
                        >
                            Portfolio Types
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink
                            href={route("portfolios.index")}
                            active={route().current("portfolios.index")}
                        >
                            Portfolio
                        </ResponsiveNavLink>
